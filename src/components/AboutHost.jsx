        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
            ...
            <div className="relative group">
              ...
              <div className="relative bg-zinc-900 border border-zinc-800 rounded-3xl p-6 sm:p-8 text-center space-y-4 shadow-2xl">
                <img
                  ...
                  alt="Damein - The Local Guide MS"
                  className="w-56 h-56 sm:w-64 sm:h-64 object-contain rounded-2xl mx-auto border-2 border-zinc-800 shadow-xl"
                />
                <div>
                  <h3 className="font-heading font-bold text-xl text-white">Damein</h3>
                  <p className="text-xs text-amber-400 font-semibold tracking-wide uppercase">
                    Host & Creator • The Local Guide MS
                  </p>
                </div>
                <div className="pt-2 border-t border-zinc-800 flex items-center justify-center gap-4 text-xs text-zinc-400">
                  <span className="flex items-center gap-1">
                    <MapPin className="w-3.5 h-3.5 text-red-400" /> Jackson, MS
                  </span>
                  <span>•</span>
                  <span className="flex items-center gap-1">
                    <MetaGlassesIcon className="w-3.5 h-3.5 text-amber-400" /> Meta POV Filming
                  </span>
                </div>
              </div>
            </div>
          ...
          <div className="lg:col-span-7 space-y-6">
            ...
            <p className="text-sm sm:text-base text-zinc-300 leading-relaxed">
              Welcome to <strong className="text-white">The Local Guide MS</strong>. This channel was born out of a simple passion: putting Mississippi’s mom-and-pop restaurants, legendary BBQ pits, secret coastal seafood shacks, and historic landmarks on the map.
            </p>

            <p className="text-sm text-zinc-400 leading-relaxed">
              Using first-person Meta smart glasses and 4K cameras, we take you right along for the ride. You sit at the table, see the sizzle in the kitchen, and get 100% honest, unfiltered impressions—no paid fluff, just genuine Mississippi pride.
            </p>
